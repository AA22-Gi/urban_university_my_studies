...
Примечания:
    ...
    2.Если хотите дополнить функции своими исключениями или написать отдельно дополнительно собственные
    функции - это не запрещено, мы не против, чтобы вы больше экспериментировали.
...
if __name__ == '__main__':
    assert add_everything_up(123.456, 'строка') == '123.456строка'
    assert add_everything_up('яблоко', 4215) == 'яблоко4215'
    assert add_everything_up(123.456, 7) == 130.45600000000002
